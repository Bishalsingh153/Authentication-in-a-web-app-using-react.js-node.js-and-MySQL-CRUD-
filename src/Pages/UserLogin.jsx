    ...
    return(
        ...
        <div className='bg-gray-100 flex flex-col justify-center h-screen bg-gradient-to-b from-black to-black'>
            <form onSubmit={handleSubmit} className='max-w-[400px] w-full mx-auto bg-black p-4'>
                <h2 className='text-4xl font-bold text-center py-6 text-[#00df9a]'>USER LOGIN</h2>
                <div className='text-danger'>
                {error && error}
            </div>
                <div className='flex flex-col py-2'>
                    <label className='text-white '>name</label>
                    <input onChange={e =>setValues({...values,name: e.target.value})}  className='border p-2 rounded-xl' type ="text" />
                </div>
                <div className='flex flex-col py-2'>
